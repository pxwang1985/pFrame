...
$.fn.SetList = function (a, b, c) {
    ...
    a *= b;
    if ("hor" == d) d = "left", b = $(this).width();
    else if ("ver" == d) d = "top", b = $(this).height();
    else if ("GRID" == d) d = "top", b = $(this).height();
    else return;
    b = parseInt(b / a);
    --a;
...
function page(a, b) {
    ...
    "undefined" != typeof a && (this.isdebug = !1, this.clear(), this._app = APP.get(), this.l = this._app.getDomain(), this._n = a, this.sn = this._n[0] + this._n[this._n.length - 1], this._app.add(this._n, this), this._f = "", this.bb = this.init_data(), this.addbg(),this.init());
    1 == b && this.enter()
};
...
SSD.prototype.refresh = function (a, b) {
    this._____ = a;
    this.c = "undefined" != typeof b ? b : 0;
    "undefined" != typeof a && a && 0 < a.length ? this.d_._(a) : this.d_._([{ "id": this.__ + "_null", "type": "list", "show": [{ "class": "null", "text": "Null Data" }] }]);
    return this
};

SSD.prototype.temp = function (a, b) {
    this._____ = a;
    this.c = "undefined" != typeof b ? b : 0;
    "undefined" != typeof a && a && 0 < a.length ? this.d_._(a) : this.d_._([{ "id": this.__ + "_null", "type": "list", "show": [{ "class": "null", "text": "Receiving Data" }] }]);
    return this
};
...
SSD.prototype.do = function (a, b) {
    ...
    switch (a) {
        ...
        case "select": { d.AreaSelect(b); } break;
